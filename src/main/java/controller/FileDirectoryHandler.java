...
public class FileDirectoryHandler {
     ...
     * @return file
     */
    //public static File renameFile(String baseDir, String fileDir, String fileName, String newFileName) {
    public File renameFile(String fileName, String newFileName) {
